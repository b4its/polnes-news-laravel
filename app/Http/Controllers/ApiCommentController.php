...
class ApiCommentController extends Controller
{
    ...
    public function storeComment(Request $request, $newsId)
    {
        try {
            ...
            // 3. Validasi input
            // Kita validasi userId dan rating (1-5)
            ...
            // Opsional: Cek apakah user sudah pernah memberi rating pada berita ini
            // Jika ingin user hanya boleh 1x rating, aktifkan blok kode ini:
            /*
